...
<!--
	This page is provided to admin to login into the GetTaxi application.
			 This page will display all the bookings which are unassigned and pickup time less than 2 hours from now.
			Admin can assign taxi's based on the reference number displayed in the table.
--> 
  <head> 
